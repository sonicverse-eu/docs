---
title: Audio pipeline architecture and signal flow
description: Understand how audio flows from your studio encoder through Liquidsoap, Icecast2, and Nginx, including the HLS adaptive bitrate pipeline and fallback chain.
---
