---
title: Firewall and port configuration for streaming
description: Open the required ports for HTTP, HTTPS, and studio encoder inputs, then run the automated UFW firewall script to lock down your streaming server.
---
