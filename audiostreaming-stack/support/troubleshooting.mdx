---
title: Quick fixes for common Docker and audio errors
description: Step-by-step solutions for containers not starting, missing audio output, status panel errors, high resource usage, and Docker Compose configuration failures.
---
...
- Verify the status API container is running:
...
- Review the status API logs for errors:
