---
title: Contributing
description: How to contribute to the audio streaming stack
---
...
<Tip>
  Use `./install.sh --dev` or run `./install-dev-deps.sh` to install Node.js and Python dependencies for local development without needing to enter each service directory.
</Tip>
