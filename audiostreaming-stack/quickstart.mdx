...
We recommend deploying the audio streaming stack on [Hetzner Cloud](https://hetzner.cloud/?ref=FX3u0ARooaLR). Hetzner offers reliable, high-performance cloud servers at competitive prices — ideal for running audio streaming infrastructure.

<a href="https://hetzner.cloud/?ref=FX3u0ARooaLR">
  <img src="/images/hetzner-cloud.png" alt="Hetzner Cloud — Server, Cloud, Hosting" width="400" />
</a>

When you sign up using the link above, you receive a **€20 promo code** valid for all Cloud products. It also helps us host our internal services and sandboxes.
