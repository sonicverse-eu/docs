...
description: Published security advisories for the audio streaming stack with severity ratings, affected versions, CVSS scores, remediation steps, and workarounds.
---
